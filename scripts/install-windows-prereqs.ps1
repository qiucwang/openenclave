...
Param(
    ...
    [string]$IntelDCAPURL = 'http://registrationcenter-download.intel.com/akdlm/irc_nas/16465/Intel%20SGX%20DCAP%20for%20Windows%20v1.5.100.2.exe',
    [string]$IntelDCAPHash = 'D5722DCECE5F227B9F9A8B83F1481C34A50AE0C762350A2ED15C5D3E849CF1D1',
